...
/// « Sofler n'est pas encore installé », au premier double-clic depuis l'image.
///
...
/// tout premier écran de Sofler, avant même l'accueil — et il pose une question
...
final class InstallPromptWindowController {
    ...
    func show(_ choice: Choice) {
        ...
        let window = NSWindow.sofler(title: "") {
    ...
    var body: some View {
        VStack(spacing: 16) {
            ...
            VStack(spacing: 10) {
                ...
                VStack(spacing: 8) {
                    Text(choice.alreadyInstalled
                         ? "Sofler est bien dans Applications, mais c'est la "
                    ...
                    Text(choice.alreadyInstalled
                         ...
                         : "Sofler peut s'installer dans **Applications** et "
