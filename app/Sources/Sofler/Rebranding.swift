...
/// Reprend ce que « Sofler » avait laissé, sous le nom de Caspr.
///
...
enum Rebranding {
    ...
    /// courants sont ceux de Caspr, et les réécrire avec ceux de Sofler
    ...
    private static func adoptPreferences() {
        ...
        NSLog("caspr: \(old.count) réglages repris de Sofler")
    }
