...
///
/// ## Pourquoi ce type vit dans `SoflerCore`
///
/// Il décrit le format de données le plus irremplaçable du projet : des heures
/// de parole réelle qu'aucune réinstallation ne reconstituera. `SoflerCore` est
...
public struct CorpusEntry: Codable, Sendable {
    ...
    /// La version de Sofler qui a produit cette dictée.
    ///
