#!/usr/bin/env bash
# Installation complète de Caspr, en une commande.
#
...
[ "$(uname -m)" = "arm64" ] || { echo "  Caspr exige un Mac Apple Silicon." >&2; exit 1; }
...
cat <<'DONE'
  ...
  déléguer à une application :
    ...
    2. Accessibilité — Réglages Système › Confidentialité et sécurité
                       › Accessibilité → ajouter Caspr

  Puis : ouvrir Caspr, taper Option droite, parler, taper à nouveau.

DONE
open /Applications/Caspr.app
