#!/usr/bin/env bash
# Installation complète de Sofler, en une commande.
#
...
[ "$(uname -m)" = "arm64" ] || { echo "  Sofler exige un Mac Apple Silicon." >&2; exit 1; }
...
cat <<'DONE'
  ...
  déléguer à une application :
    ...
    2. Accessibilité — Réglages Système › Confidentialité et sécurité
                       › Accessibilité → ajouter Sofler

  Puis : ouvrir Sofler, taper Option droite, parler, taper à nouveau.

DONE
open /Applications/Sofler.app
