/**
 * SOFLER LANDING PAGE - TRANSLATIONS (FR & EN)
...
const TRANSLATIONS = {
  fr: {
    // Meta & Head
    pageTitle: "Sofler — Dictée Vocale IA 100% Locale & Open Source pour macOS",
    ...
    heroVersionTag: "Sofler.dmg · macOS 14+ · Apple Silicon & Intel · Gratuit",
    ...
    simWindowTitle: "Simulation en direct du cycle d'enregistrement Sofler",
    simFileName: "compte-rendu.md",
    simColPos: "Ln 14, Col 32",
    simEditorFaded1: "# Architecture Sofler — Dictée Locale",
    ...
    compTitle: "Pourquoi la dictée classique est frustrante,<br>et comment Sofler la réinvente.",
    compSubtitle: "Les dictées classiques écrivent chaque 'euh', répétition et bégaiement. Sofler écoute votre flux de pensée et restitue un texte propre, structuré et ponctué.",
    ...
    compSoflerBadge: "✨ Avec Sofler (CrisperWhisper IA)",
    compSoflerTitle: "Nettoyée, Structurée & Ponctuée",
    compSoflerSpeech: "\"On va créer la fonction <code>fetchUserData</code> avec un bloc try/catch, et renvoyer <code>null</code> en cas d'erreur.\"",
    compSoflerP1: "Suppression automatique des 'euh', bégaiements et hésitations",
    compSoflerP2: "Ponctuation naturelle et majuscules inférées par le sens",
    compSoflerP3: "Reconnaissance parfaite des termes de code et du franglais",

    // Dual Engines Section
    enginesTag: "Flexibilité & Performance",
    enginesTitle: "Deux Moteurs au Choix.<br>Adaptez Sofler à vos Besoins.",
    ...
    bento1Desc: "Votre voix et vos textes ne quittent jamais votre Mac. L'inférence tourne localement sur Apple Silicon (Metal/MPS) ou CPU Intel. Coupez votre Wi-Fi : Sofler fonctionne exactement pareil.",
    ...
    osSubtitle: "Sofler appartient à la communauté. Aucun abonnement caché, aucun bridage payant, aucun code propriétaire opaque.",
    ...
    osCard3Desc: "Sofler intègre un désinstallateur propre qui supprime l'environnement Python, les caches et modèles sans laisser le moindre fichier orphelin sur votre Mac.",
    btnViewGithub: "Voir le dépôt GitHub",

    // Download Modal
    modalTitle: "Téléchargement de Sofler en cours… 🚀",
    modalSubtitle: "Votre fichier <code>Sofler.dmg</code> est en cours de téléchargement. Suivez ces étapes simples pour l'ouvrir sur votre Mac :",
    modalWhyTitle: "💡 Pourquoi ces étapes spécifiques ?",
    modalWhyDesc: "Sofler est un projet <strong>100% open source et gratuit</strong>. Nous ne payons pas l'abonnement Apple Developer à 99$/an, ce qui fait que macOS affiche un avertissement de sécurité par défaut. Suivre ces étapes ne prend que <strong>30 secondes</strong> et n'est à faire qu'une seule fois !",
    modalStep1Title: "1. Double-cliquez sur le DMG",
    modalStep1Desc: "Ouvrez le fichier <code>Sofler.dmg</code> téléchargé, puis double-cliquez sur l'icône Sofler.",
    ...
    modalStep4Desc: "Dans la fenêtre Sofler, cliquez sur <strong>[ Installer et ouvrir ]</strong>. L'application se déplace toute seule dans <code>/Applications</code> et s'ouvre !",
    ...
    faqTitle: "Tout ce que vous devez savoir sur Sofler",
    faq1Q: "Quelles sont les configurations Mac compatibles ?",
    faq1A: "Sofler est compatible avec <strong>macOS 14 (Sonoma)</strong>, <strong>macOS 15 (Sequoia)</strong> et supérieur. Il fonctionne à pleine vitesse sur les puces <strong>Apple Silicon (M1, M2, M3, M4)</strong> grâce à l'accélération matérielle, et prend également en charge les processeurs <strong>Intel</strong>.",
    faq2Q: "Mes données audio ou transcriptions peuvent-elles être envoyées sur Internet ?",
    faq2A: "<strong>Non, jamais.</strong> Sofler fonctionne en circuit 100% fermé. L'application ne possède aucun serveur backend, aucun compte utilisateur, aucune connexion API cloud et aucun outil de télémétrie. Votre voix reste strictement confinée dans la mémoire vive de votre Mac.",
    faq3Q: "Pourquoi macOS affiche-t-il un message lors de la première ouverture ?",
    faq3A: "Pour distribuer une application sans avertissement Gatekeeper, Apple exige un compte développeur payant annuel de 99$/an. En tant que projet 100% open source et gratuit, Sofler est distribué librement. Suivre le guide en 1 clic (Ouvrir quand même dans Réglages Système) suffit à autoriser l'application de façon permanente.",
    faq4Q: "Comment fonctionne la touche ⌥ Option pour dicter ?",
    faq4A: "C'est le mode <em>Hold-to-talk</em> : maintenez la touche Option enfoncée pendant que vous parlez, puis relâchez-la. Dès le relâchement, Sofler nettoie le texte et l'injecte instantanément sous votre curseur actif.",
    faq5Q: "Puis-je utiliser Sofler dans du code ou en Franglais ?",
    ...
    bottomDesc: "Téléchargez Sofler gratuitement et découvrez la puissance d'une dictée vocale locale nouvelle génération sur votre Mac.",
    bottomBtn: "Télécharger Sofler pour macOS",
  ...
  en: {
    // Meta & Head
    pageTitle: "Sofler — 100% Local & Open Source AI Voice Dictation for macOS",
    ...
    heroVersionTag: "Sofler.dmg · macOS 14+ · Apple Silicon & Intel · Free",
    ...
    simWindowTitle: "Live simulation of the Sofler recording lifecycle",
    simFileName: "meeting-notes.md",
    simColPos: "Ln 14, Col 32",
    simEditorFaded1: "# Sofler Architecture — Local Dictation",
    ...
    compTitle: "Why standard dictation is frustrating,<br>and how Sofler reinvents it.",
    compSubtitle: "Classic dictation engines write every 'um', repetition, and stutter. Sofler understands your train of thought and delivers clean, structured, and punctuated text.",
    ...
    compSoflerBadge: "✨ With Sofler (CrisperWhisper AI)",
    compSoflerTitle: "Cleaned, Structured & Punctuated",
    compSoflerSpeech: "\"Let's create the <code>fetchUserData</code> function with a try/catch block, and return <code>null</code> on error.\"",
    compSoflerP1: "Automatic removal of 'ums', repetitions and false starts",
    compSoflerP2: "Natural punctuation and capitalization inferred from sentence context",
    compSoflerP3: "Flawless recognition of code variables, acronyms and tech terms",

    // Dual Engines Section
    enginesTag: "Flexibility & Performance",
    enginesTitle: "Two Engines Included.<br>Tailor Sofler to your Workflow.",
    ...
    bento1Desc: "Your voice and text never leave your Mac. Inference runs locally on Apple Silicon (Metal/MPS) or Intel CPU. Turn off your Wi-Fi: Sofler runs exactly the same.",
    ...
    osSubtitle: "Sofler belongs to the community. No hidden subscriptions, no paywalled features, no opaque proprietary code.",
    ...
    osCard3Desc: "Sofler includes a dedicated clean uninstaller that completely wipes the Python environment, caches, and models without leaving orphan files on your Mac.",
    btnViewGithub: "View GitHub Repository",

    // Download Modal
    modalTitle: "Downloading Sofler… 🚀",
    modalSubtitle: "Your <code>Sofler.dmg</code> file is downloading. Follow these simple steps to open it on your Mac:",
    modalWhyTitle: "💡 Why are these extra steps required?",
    modalWhyDesc: "Sofler is a <strong>100% free and open-source</strong> project. We do not pay Apple's $99/year Developer Program fee, so macOS displays a default security notice. Following these steps takes only <strong>30 seconds</strong> and is done just once!",
    modalStep1Title: "1. Double-click the DMG",
    modalStep1Desc: "Open the downloaded <code>Sofler.dmg</code> file, then double-click the Sofler app icon.",
    ...
    modalStep4Desc: "In the Sofler dialog, click <strong>[ Install and open ]</strong>. The app automatically moves itself to <code>/Applications</code> and launches!",
    modalBtnClose: "Got it!",
    modalRestartDownload: "Download didn't start? Click here to restart.",

    // FAQ
    faqTag: "Frequently Asked Questions",
    faqTitle: "Everything you need to know about Sofler",
    faq1Q: "Which Mac models and macOS versions are supported?",
    faq1A: "Sofler is compatible with <strong>macOS 14 (Sonoma)</strong>, <strong>macOS 15 (Sequoia)</strong> and later. It runs at full speed on <strong>Apple Silicon chips (M1, M2, M3, M4)</strong> using Metal/MPS GPU acceleration, and fully supports <strong>Intel</strong> Macs.",
    faq2Q: "Can my audio recordings or text ever be sent over the internet?",
    faq2A: "<strong>No, never.</strong> Sofler operates completely offline. The app has no backend servers, no user accounts, no cloud API connections, and zero telemetry. Your voice strictly remains in your Mac's memory.",
    faq3Q: "Why does macOS show a security prompt on first launch?",
    faq3A: "To distribute software without Gatekeeper prompts, Apple requires a recurring $99/year developer subscription. As a 100% free and open-source project, Sofler is distributed directly. Following the 1-click step (Open Anyway in System Settings) permanently authorizes the app on your Mac.",
    faq4Q: "How does the ⌥ Option key dictation trigger work?",
    faq4A: "It's <em>Hold-to-talk</em>: simply hold the Option key down while you speak, then release it. The moment you release, Sofler cleans the text and instantly types it right where your cursor is.",
    faq5Q: "Can I use Sofler with programming code and technical terms?",
    ...
    bottomDesc: "Download Sofler for free and experience the power of next-generation local voice dictation on your Mac.",
    bottomBtn: "Download Sofler for macOS",
